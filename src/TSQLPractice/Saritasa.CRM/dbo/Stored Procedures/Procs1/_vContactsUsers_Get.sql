...
-- Created By:  ()
-- Purpose: Gets records from the _vContactsUsers view passing page index and page count parameters
----------------------------------------------------------------------------------------------------
*/


CREATE PROCEDURE [dbo].[_vContactsUsers_Get]
(
...
AS
				...
				SET @SQL = @SQL + ' FROM [dbo].[_vContactsUsers]'
