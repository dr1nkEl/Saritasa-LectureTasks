...
-- Created By:  ()
-- Purpose: Gets records from the _vDailyReportList view passing page index and page count parameters
----------------------------------------------------------------------------------------------------
*/


CREATE PROCEDURE [dbo].[_vDailyReportList_Get]
(
...
AS
				...
				SET @SQL = @SQL + ', [userCreated]'
				SET @SQL = @SQL + ' FROM [dbo].[_vDailyReportList]'
