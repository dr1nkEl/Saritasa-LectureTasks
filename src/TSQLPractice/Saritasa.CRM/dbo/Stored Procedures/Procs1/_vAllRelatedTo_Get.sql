...
-- Created By:  ()
-- Purpose: Gets records from the _vAllRelatedTo view passing page index and page count parameters
----------------------------------------------------------------------------------------------------
*/


CREATE PROCEDURE [dbo].[_vAllRelatedTo_Get]
(
...
AS
				...
				SET @SQL = @SQL + ' FROM [dbo].[_vAllRelatedTo]'
