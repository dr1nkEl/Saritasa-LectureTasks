...
-- Created By:  ()
-- Purpose: Gets records from the _vProjectsDocuments view passing page index and page count parameters
----------------------------------------------------------------------------------------------------
*/


CREATE PROCEDURE [dbo].[_vProjectsDocuments_Get]
(
...
AS
				...
				SET @SQL = @SQL + ' FROM [dbo].[_vProjectsDocuments]'
