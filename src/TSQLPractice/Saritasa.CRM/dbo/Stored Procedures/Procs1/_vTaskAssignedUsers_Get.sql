...
-- Created By:  ()
-- Purpose: Gets records from the _vTaskAssignedUsers view passing page index and page count parameters
----------------------------------------------------------------------------------------------------
*/


CREATE PROCEDURE [dbo].[_vTaskAssignedUsers_Get]
(
...
AS
				...
				SET @SQL = @SQL + ' FROM [dbo].[_vTaskAssignedUsers]'
