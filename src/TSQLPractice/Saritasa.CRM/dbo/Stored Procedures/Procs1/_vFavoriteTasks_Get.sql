...
-- Created By:  ()
-- Purpose: Gets records from the _vFavoriteTasks view passing page index and page count parameters
----------------------------------------------------------------------------------------------------
*/


CREATE PROCEDURE [dbo].[_vFavoriteTasks_Get]
(
...
AS
				...
				SET @SQL = @SQL + ', [projectShowClient]'
				SET @SQL = @SQL + ', [favoriteUserID]'
				SET @SQL = @SQL + ', [favoritesCreated]'
				SET @SQL = @SQL + ', [makeJobsBillable]'
				SET @SQL = @SQL + ', [projectOverbudget]'
				SET @SQL = @SQL + ' FROM [dbo].[_vFavoriteTasks]'
