...
-- Created By:  ()
-- Purpose: Gets records from the _vTaskForRelated view passing page index and page count parameters
----------------------------------------------------------------------------------------------------
*/


CREATE PROCEDURE [dbo].[_vTaskForRelated_Get]
(
...
AS
				...
				SET @SQL = @SQL + ' FROM [dbo].[_vTaskForRelated]'
