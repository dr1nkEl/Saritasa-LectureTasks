...
-- Created By:  ()
-- Purpose: Gets records from the _vUserAuth view passing page index and page count parameters
----------------------------------------------------------------------------------------------------
*/


CREATE PROCEDURE [dbo].[_vUserAuth_Get]
(
...
AS
				...
				SET @SQL = @SQL + ' FROM [dbo].[_vUserAuth]'
