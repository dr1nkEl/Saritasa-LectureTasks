CREATE TABLE [dbo].[aspnet_Users] (
    ...
    CONSTRAINT [PK__aspnet_Users__71A7CADF] PRIMARY KEY NONCLUSTERED ([UserId] ASC) WITH (FILLFACTOR = 80),
    CONSTRAINT [FK__aspnet_Us__Appli__729BEF18] FOREIGN KEY ([ApplicationId]) REFERENCES [dbo].[aspnet_Applications] ([ApplicationId])
);
